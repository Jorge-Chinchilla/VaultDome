...
<template>
  <main>
    ...
    <div id="signup-f">
      <div id="signup-s">
        <div id="btn-sup" class="mb-3"> <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
        ...
        <div id="btn-sup" class="mb-3">
          <button id="" type="button" class="btn btn-outline-secondary">Sign Up
